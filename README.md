# 🚀 TaskFlow – Full Stack Task Management Application with Spring Boot, Angular & JWT Security

TaskFlow is a secure, production-ready full-stack Task Management Web Application built using **Spring Boot (Java)** and **Angular (Standalone Architecture)** with **JWT-based authentication** and **MySQL database**.
